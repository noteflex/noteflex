...
const ko: Strings = {
  ...
  authModal: {
    ...
    giftBullet2: "Lv1~2 전체 + Lv3 첫 단계 무료 연습",
  ...
  analytics: {
    ...
    weeklyDeltaMsFaster: "▲{n}s 더 빨라짐",
    weeklyDeltaMsSlower: "▼{n}s 더 느려짐",
    ...
    monthlyDeltaMsFaster: "▲{n}s 더 빨라짐",
    monthlyDeltaMsSlower: "▼{n}s 더 느려짐",
...
const en: Strings = {
  ...
  authModal: {
    ...
    giftBullet2: "Free practice: Levels 1–2 full + Level 3 Sub1",
  ...
  premiumDialog: {
    title: "✨ Unlock All Levels with Premium",
  ...
  analytics: {
    ...
    weeklyDeltaMsFaster: "▲{n}s faster",
    weeklyDeltaMsSlower: "▼{n}s slower",
    ...
    monthlyDeltaMsFaster: "▲{n}s faster",
    monthlyDeltaMsSlower: "▼{n}s slower",
  ...
  levelSelect: {
    ...
    proBadge: "PRO",
    achieved: "{n}/4 done",
    aria: { proOnly: "Premium only", locked: "Locked", select: "Select", passedReplay: "Passed (replay available)", inProgress: "In progress" },
    levels: [
