...
음정 패턴을 먼저 익히는 이유는 인지 부하 때문이다. 음표 하나하나를 명칭으로 변환하는 학습자는 한 마디에 6~8번의 변환을 수행한다. 음정 패턴으로 읽는 학습자는 한 마디에 2~3번의 변환만으로 끝난다. 같은 곡을 봐도 어른의 뇌가 처리해야 하는 인지 부하가 1/3로 줄어든다.
