...
coverImageAlt: "에빙하우스 망각 곡선 — 복습 없이 시간이 지남에 따라 기억 보존율이 하락하는 과정"
...
![에빙하우스 망각 곡선 — 복습 없이 시간이 지남에 따라 기억 보존율이 하락하는 과정을 나타낸 도표, 간격 반복 학습과 가중치 학습의 과학적 근거](https://upload.wikimedia.org/wikipedia/commons/d/dc/Ebbinghaus_Forgetting_Curve.jpg)
*그림 1: 에빙하우스 망각 곡선. [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Ebbinghaus_Forgetting_Curve.jpg) — CC BY-SA 3.0. Credit: Nheise.*
...
![헤르만 에빙하우스(1850–1909)의 역사적 초상 사진 — 기억과 망각에 관한 실험 연구로 현대 간격 반복 학습의 토대를 놓은 독일 심리학자](https://upload.wikimedia.org/wikipedia/commons/9/92/Ebbinghaus2.jpg)
*그림 2: Hermann Ebbinghaus (1850–1909). [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Ebbinghaus2.jpg) — Public Domain.*
