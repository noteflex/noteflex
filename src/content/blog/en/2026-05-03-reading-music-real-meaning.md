---
title: "What \"Reading Music\" Actually Means — Compared with Reading Text"
date: "2026-05-03"
description: "\"Reading music\" sounds parallel to reading text, but in cognitive terms it is a multi-channel translation involving vision, audition, and motor planning at the same time. Here is what the two have in common, and where they diverge."
keywords: ["reading music", "sight-reading", "music cognition", "music learning", "visual processing"]
...
1. **Vision → pitch name** — recognizing that a position on the staff corresponds to C, G, etc.
2. **Pitch name → auditory image** — imagining how that pitch sounds.
3. **Auditory image → motor command** — directing the appropriate finger to the appropriate key (or vocal cord, or breath).
4. **Motor → auditory feedback** — comparing the produced sound with the imagined image.
