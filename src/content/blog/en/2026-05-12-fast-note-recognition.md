---
title: "The Science of Fast Note Recognition — Where the Eye Stops Decides the Speed"
date: 2026-05-12
description: "Sight-reading speed is not built from 'more practice' in general. It comes down to where the eye stops and how long it stays there. Eye-tracking research has mapped the fixation–saccade patterns that distinguish a fluent reader from a beginner, and the difference is not what most learners assume."
keywords: ["note recognition speed", "sight-reading speed", "fixation", "saccade", "eye tracking", "music cognition"]
