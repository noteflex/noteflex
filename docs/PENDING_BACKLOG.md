...
- [ ] §0.2 Lv5+ 조표 비율 (6:4 / 4:6 / 7:3 / 3:7)
- [ ] §0.3 카운트다운 후 첫 음표 버퍼링 (Lv 7-3 1.05초 부담 완화)
- [ ] §0-1.1 코드 적용: PASS_CRITERIA 갱신 (정답률 85% / 반응속도 평균 35% / 수행 10회 / 최대 연속 5회)
- [ ] §0-1.2 코드 적용: SUBLEVEL_CONFIGS 갱신 (Sub 3 = 3 stage)
- [ ] §0-1.4 코드 적용: 음표 배치 + set 반복 횟수 갱신
- [ ] §0-1.5 코드 적용: 재도전 배지 삭제 (10분)
- [ ] §0-1.6 코드 적용: 같은 조표 연속 학습 구현
